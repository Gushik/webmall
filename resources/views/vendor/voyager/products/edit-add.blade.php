                ...
                <div class="panel panel-bordered">
                    ...
                    <!-- CSRF TOKEN -->
                        ...
                        <!-- Adding / Editing -->
                            ...
                            @php
                                $attributeOption = App\Models\Attribute::with('values')->get();
                            @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="product_attributes[{{$attr->name}}]">
                                        ...
                                        @foreach ($attr->values as $val)
                                            <option {{(!empty(json_decode($dataTypeContent->product_attributes,true)[$attr->name]) &&
                                                        json_decode($dataTypeContent->product_attributes,true)[$attr->name] == $val->value) ? 'selected' : ''}}
                                            >{{$val->value}}</option>
                                        @endforeach
                                    </select>
                                </div>
